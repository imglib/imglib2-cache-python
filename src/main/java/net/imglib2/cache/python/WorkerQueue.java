...
public class WorkerQueue<B extends Buffer> {
    ...
    public static class Task<B extends Buffer> { // (val buf: DoubleBuffer, val index: Long, val min: LongArray, val max: LongArray, val dim: IntArray, val code: String, val blockName: String? = null) {
